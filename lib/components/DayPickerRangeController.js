	  ...
	  _createClass(DayPickerRangeController, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var isDayHighlightedPrevious = _props8.isDayHighlightedPrevious;
	        ...
	        var withControls = _props8.withControls;
	        var withShortcuts = _props8.withShortcuts;
	        var enableOutsideDays = _props8.enableOutsideDays;
	        var _initialVisibleMonth = _props8.initialVisibleMonth;
	        var focusedInput = _props8.focusedInput;
	        var renderDay = _props8.renderDay;
	        var selectedShortcut = _props8.selectedShortcut;
	        var selectedShortcutPrevious = _props8.selectedShortcutPrevious;
	        var shortcuts = _props8.shortcuts;
	        var shortcutsPrevious = _props8.shortcutsPrevious;
	        var onPreviousDatesChange = _props8.onPreviousDatesChange;
	        var onPreviousShortcutChange = _props8.onPreviousShortcutChange;
	        var previousStartDate = _props8.previousStartDate;
	        var previousEndDate = _props8.previousEndDate;

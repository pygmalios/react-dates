	  ...
	  _createClass(DateRangePickerInput, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var hasSingleInput = selectedShortcut.period;
	        ...
	        var startDisplayValue = selectedShortcut.period ? selectedShortcut.name : startDate;
	        ...
	        }), !hasSingleInput && _react2['default'].createElement('div', { className: 'DateRangePickerInput__arrow' }, arrowIcon), !hasSingleInput && _react2['default'].createElement(_DateInput2['default'], {
	          id: endDateId,

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DateInput = __webpack_require__(25);
	...
	var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
	  ...
	  withSingleInput: _react.PropTypes.bool,
	  showDropdownCaret: _react.PropTypes.bool
	});
	    ...
	    value: function () {
	      function render() {
	        ...
	        var _props = this.props,
	            ...
	            withSingleInput = _props.withSingleInput,
	            showDropdownCaret = _props.showDropdownCaret;

	        var hasDefaultPeriod = selectedShortcut.range;
	        ...
	        var startDisplayValue = hasDefaultPeriod ? selectedShortcut.name : startDate;
	        startDisplayValue = withSingleInput && !hasDefaultPeriod ? String(startDisplayValue || 'Start Date') + ' - ' + String(endDate || 'End Date') : startDisplayValue;
	        ...
	        }), !hasDefaultPeriod && !withSingleInput && _react2['default'].createElement('div', { className: 'DateRangePickerInput__arrow' }, arrowIcon), !hasDefaultPeriod && !withSingleInput && _react2['default'].createElement(_DateInput2['default'], {
	          id: endDateId,
	        ...
	        }, _react2['default'].createElement('span', { className: 'screen-reader-only' }, phrases.clearDates), _react2['default'].createElement(_close2['default'], null)), showDropdownCaret && _react2['default'].createElement('b', {
	          className: (0, _classnames2['default'])('DateRangePickerInput__caret', {

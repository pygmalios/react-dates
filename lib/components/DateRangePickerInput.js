	  ...
	  _createClass(DateRangePickerInput, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        }, _react2['default'].createElement('span', { className: 'screen-reader-only' }, phrases.clearDates), _react2['default'].createElement(_close2['default'], null)), withSingleInput && _react2['default'].createElement('b', {

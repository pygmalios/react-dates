	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function () {
	      function adjustDayPickerHeight() {
	        ...
	        if (newMonthHeight !== calculateDimension(this.transitionContainer, 'height')) {
	          ...
	          var shortcutsHeight = 50;
	          this.transitionContainer.style.height = String(newMonthHeight + shortcutsHeight) + 'px';
	        }
	      }
	    ...
	    value: function () {
	      function render() {
	        ...
	        var onShortcutClick = _props2.onShortcutClick;
	        ...
	        var transitionContainerWidth = CALENDAR_MONTH_WIDTH * numberOfMonths + 2 * DAY_PICKER_PADDING;
	        ...
	        return _react2['default'].createElement('div', { className: dayPickerClassNames, style: dayPickerStyle }, _react2['default'].createElement(_OutsideClickHandler2['default'], { onOutsideClick: onOutsideClick }, _react2['default'].createElement('div', { style: contentContainerStyle, className: 'DayPicker__content' }, _react2['default'].createElement('div', { style: { width: transitionContainerWidth } }, !verticalScrollable && this.renderNavigation()), _react2['default'].createElement('div', { className: 'DayPicker__week-headers' }, weekHeaders), _react2['default'].createElement('div', {

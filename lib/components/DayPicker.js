	    ...
	    value: function () {
	      function onShortcutClick(shortcut) {
	        ...
	        this.setState({
	          ...
	          translationValue: translationValue,
	          translationCount: Math.abs(diff)
	        });
	      }
	    ...
	    value: function () {
	      function updateStateAfterMonthTransition() {
	        var _state = this.state,
	            ...
	            translationCount = _state.translationCount;
	    ...
	    value: function () {
	      function render() {
	        ...
	        var _state2 = this.state,
	            ...
	            translationCount = _state2.translationCount,
	        ...
	        var _props2 = this.props,
	            ...
	            withShortcuts = _props2.withShortcuts,
	            ...
	            selectedShortcut = _props2.selectedShortcut,
	            shortcuts = _props2.shortcuts,
	            isPrevious = _props2.isPrevious;
	        ...
	        }, _react2['default'].createElement('div', { style: { width: transitionContainerWidth } }, !this.isVertical() && this.renderNavigation()), _react2['default'].createElement('div', { className: 'DayPicker__week-headers' }, weekHeaders), _react2['default'].createElement('div', { tabIndex: -1, style: { outline: 'none' } }, _react2['default'].createElement('div', {
	        ...
	        })), this.isVertical() && this.renderNavigation()), !this.isVertical() && withShortcuts && _react2['default'].createElement(_DayPickerShortcuts2['default'], {
	          ref: function () {
	            function ref(_ref3) {

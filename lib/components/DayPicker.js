...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DayPickerShortcuts = __webpack_require__(35);

	var _DayPickerShortcuts2 = _interopRequireDefault(_DayPickerShortcuts);
	...
	var DAY_WIDTH = 32;
	var CALENDAR_MONTH_WIDTH = 32 * 7;
	var DAY_PICKER_SHORTCUTS = 32 * 7;
	var MONTH_PADDING = 32;
	...
	var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
	  ...
	  onShortcutClick: _react.PropTypes.func,
	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function () {
	      function onShortcutClick(shortcut) {
	        ...
	        var _shortcut$range = _slicedToArray(shortcut.range, 1);

	        var startDate = _shortcut$range[0];

	        var diff = currentMonth.clone().startOf('month').diff(startDate.clone().startOf('month'), 'month');
	        var translationValue = (this.isVertical() ? this.getMonthHeightByIndex(1) : this.dayPickerWidth) * diff;
	        if (diff === 0) return;
	        if (diff > 1) this.translateFirstDayPickerForAnimation(translationValue);

	        var monthTransition = diff < 0 ? NEXT_TRANSITION : PREV_TRANSITION;

	        this.setState({ monthTransition: monthTransition, translationValue: translationValue, translationCount: Math.abs(diff) });
	      }
	    ...
	    value: function () {
	      function initializeDayPickerWidth() {
	        ...
	        _reactDom2['default'].findDOMNode(this.calendarMonthGrid).querySelector('.CalendarMonth').querySelector('table'), 'width', true);
	      }
	    ...
	    value: function () {
	      function updateStateAfterMonthTransition() {
	        ...
	        var translationCount = _state.translationCount;
	    ...
	    value: function () {
	      function adjustDayPickerHeight() {
	        var shortcutContainer = _reactDom2['default'].findDOMNode(this.shortcutsContainer);
	        var sHeight = calculateDimension(shortcutContainer, 'height') + DAY_WIDTH;
	        var heights = [sHeight];
	    ...
	    value: function () {
	      function render() {
	        ...
	        var translationCount = _state2.translationCount;
	        ...
	        var withShortcuts = _props2.withShortcuts;
	        ...
	        var isPrevious = _props2.isPrevious;
	        ...
	        var transitionContainerWidth = CALENDAR_MONTH_WIDTH * numberOfMonths + 2 * DAY_WIDTH;
	        var horizontalWidth = transitionContainerWidth + (withShortcuts ? DAY_PICKER_SHORTCUTS : 0);
	        ...
	        return _react2['default'].createElement('div', { className: dayPickerClassNames, style: dayPickerStyle }, _react2['default'].createElement(_OutsideClickHandler2['default'], { onOutsideClick: onOutsideClick }, _react2['default'].createElement('div', {
	          ref: function () {
	            function ref(_ref4) {
	              _this2.contentContainer = _ref4;
	            }

	            return ref;
	          }(),
	          style: contentContainerStyle, className: 'DayPicker__content'
	        }, _react2['default'].createElement('div', { style: { width: transitionContainerWidth } }, !verticalScrollable && this.renderNavigation()), _react2['default'].createElement('div', { className: 'DayPicker__week-headers' }, weekHeaders), _react2['default'].createElement('div', {
	        ...
	        }), verticalScrollable && this.renderNavigation()), !verticalScrollable && withShortcuts && _react2['default'].createElement(_DayPickerShortcuts2['default'], {
	          ref: function () {
	            function ref(_ref3) {
	              _this2.shortcutsContainer = _ref3;
	            }
...
/***/ function(module, exports) {
	...
	module.exports = require("./DayPickerShortcuts");

	  ...
	  _createClass(DayPickerControls, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement('div', { className: 'DayPickerControls' }, _react2['default'].createElement('div', { className: 'DayPickerControls__inputs' }, _react2['default'].createElement('div', null, _react2['default'].createElement('input', {
	        ...
	        }), _react2['default'].createElement('label', { htmlFor: 'compare-to-checkbox' }, _react2['default'].createElement('span', null), 'Compare to')), isComparing && _react2['default'].createElement('div', { className: 'DateRangePicker' }, _react2['default'].createElement(_DateRangePickerInputController2['default'], {
	          customArrowIcon: '-',
	          startDate: startDate,
	        ...
	        })), isComparing && _react2['default'].createElement('span', null, 'By'), isComparing && _react2['default'].createElement('select', { value: compareBy, onChange: function () {
	        ...
	        }))), _react2['default'].createElement('div', { className: 'DayPickerControls__buttons' }, _react2['default'].createElement('button', { className: 'success', type: 'button', onClick: onApply }, 'Apply'), _react2['default'].createElement('button', { type: 'button', onClick: onCancel }, 'Cancel')));
	      }

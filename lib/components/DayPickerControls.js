	...
	var Checkbox = function () {
	  function Checkbox(_ref) {
	    ...
	    return _react2['default'].createElement('div', null, _react2['default'].createElement('input', {
	      ...
	      checked: checked,
	      onChange: onClick
	    }), _react2['default'].createElement('label', { htmlFor: 'compare-to-checkbox' }, _react2['default'].createElement('span', null, checked ? _react2['default'].createElement(_check4['default'], { stroke: 'pink', width: '16', height: '16' }) : _react2['default'].createElement(_check2['default'], { fill: 'white', width: '16', height: '16' })), 'Compare to'));
	  }

	  ...
	  _createClass(DayPickerControls, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement('div', { className: 'DayPickerControls__inputs' }, _react2['default'].createElement('label', { htmlFor: 'compare-to-checkbox' }, 'Compare to', _react2['default'].createElement('input', {
	        ...
	        })), _react2['default'].createElement('button', { className: 'success', type: 'button', onClick: onApply }, 'Apply'), _react2['default'].createElement('button', { type: 'button', onClick: onCancel }, 'Cancel'));
	      }

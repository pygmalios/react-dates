	  ...
	  _createClass(DayPickerControls, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement('div', { className: 'DayPickerControls' }, _react2['default'].createElement('div', { className: 'DayPickerControls__inputs' }, _react2['default'].createElement('label', { htmlFor: 'compare-to-checkbox' }, 'Compare to', _react2['default'].createElement('input', {

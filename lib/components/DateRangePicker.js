	  ...
	  _createClass(DateRangePicker, [{
	    ...
	    value: function () {
	      function componentDidMount() {
	        this.resizeHandle = (0, _consolidatedEvents.addEventListener)(window, 'resize', this.responsivizePickerPosition, {
	          passive: true
	        });
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var _props4 = this.props,
	            ...
	            isDayHighlightedPrevious = _props4.isDayHighlightedPrevious,
	            ...
	            selectedShortcut = _props4.selectedShortcut,
	            selectedShortcutPrevious = _props4.selectedShortcutPrevious,
	            onShortcutChange = _props4.onShortcutChange,
	            withControls = _props4.withControls,
	            withShortcuts = _props4.withShortcuts,
	            shortcuts = _props4.shortcuts,
	            shortcutsPrevious = _props4.shortcutsPrevious,
	            onPreviousDatesChange = _props4.onPreviousDatesChange,
	            onPreviousShortcutChange = _props4.onPreviousShortcutChange,
	            previousEndDate = _props4.previousEndDate,
	            previousStartDate = _props4.previousStartDate,
	            onApply = _props4.onApply,
	            onCancel = _props4.onCancel,
	            isComparing = _props4.isComparing,
	            compareBy = _props4.compareBy,
	            onCompareByChange = _props4.onCompareByChange,
	            onIsComparingToggle = _props4.onIsComparingToggle;
	        var dayPickerContainerStyles = this.state.dayPickerContainerStyles;
	        ...
	        }), withFullScreenPortal && _react2['default'].createElement('button', { className: 'DateRangePicker__close', type: 'button', onClick: this.onOutsideClick }, _react2['default'].createElement('span', { className: 'screen-reader-only' }, this.props.phrases.closeDatePicker), _react2['default'].createElement(_close2['default'], null)));
	      }
	    ...
	    value: function () {
	      function render() {
	        var _props5 = this.props,
	            ...
	            selectedShortcut = _props5.selectedShortcut,
	            withControls = _props5.withControls,
	            withSingleInput = _props5.withSingleInput,
	            showDropdownCaret = _props5.showDropdownCaret;

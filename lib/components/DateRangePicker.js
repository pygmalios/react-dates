	  ...
	  _createClass(DateRangePicker, [{
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var displayFormat = _props4.displayFormat;
	        ...
	        var isDayHighlightedPrevious = _props4.isDayHighlightedPrevious;
	        ...
	        var selectedShortcut = _props4.selectedShortcut;
	        var selectedShortcutPrevious = _props4.selectedShortcutPrevious;
	        var onShortcutChange = _props4.onShortcutChange;
	        var withControls = _props4.withControls;
	        var withShortcuts = _props4.withShortcuts;
	        var shortcuts = _props4.shortcuts;
	        var shortcutsPrevious = _props4.shortcutsPrevious;
	        var onPreviousDatesChange = _props4.onPreviousDatesChange;
	        var onPreviousShortcutChange = _props4.onPreviousShortcutChange;
	        var previousEndDate = _props4.previousEndDate;
	        var previousStartDate = _props4.previousStartDate;
	        var onApply = _props4.onApply;
	        var onCancel = _props4.onCancel;
	        var isComparing = _props4.isComparing;
	        var compareBy = _props4.compareBy;
	        var onCompareByChange = _props4.onCompareByChange;
	        var onIsComparingToggle = _props4.onIsComparingToggle;
	        var dayPickerContainerStyles = this.state.dayPickerContainerStyles;
	    ...
	    value: function () {
	      function render() {
	        ...
	        var selectedShortcut = _props5.selectedShortcut;
	        var withControls = _props5.withControls;
	        var withSingleInput = _props5.withSingleInput;
	        var showDropdownCaret = _props5.showDropdownCaret;
